...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting l.txt processing");
    
    let mut processor = l.txtProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = l.txtProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = l.txtProcessor::new(false);
